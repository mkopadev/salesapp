...
namespace SalesApp.Droid.People.Customers
{
    ...
    class CustomerListView : PersonListActivity<CustomerItem, CustomerSearchService, CustomerSearchResult>
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            this.AddToolbar(Resource.String.customer_list_title, true);
        }
            ...
            if (adapter != null)
            {
                try
                {
                    ...
                    if (_statuses.ContainsKey(_currentCustomerId))
                    {
                     ...
                     Intent intent = new Intent(this, typeof(CustomerDetailView));
                     intent.PutExtra(
                             CustomerDetailView.BundledCustomer,
        ...
        private void UpdateDataSet(bool isOnUiThread = false)
        {
            ...
            customerSearch = customerSearch
                .OrderByDescending(cust => cust.Created).ToList();
